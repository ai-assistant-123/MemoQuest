    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm animate-fade-in">
      <div className="bg-white dark:bg-gray-800 border-4 border-gray-200 dark:border-gray-600 rounded-xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh] animate-slide-up transition-colors duration-300">
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 rounded-t-lg shrink-0">
          <h3 className="text-xl text-cyan-600 dark:text-cyan-400 font-bold game-font">记忆法原理指南</h3>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6 overflow-y-auto text-gray-700 dark:text-gray-300 space-y-6 font-mono leading-relaxed custom-scrollbar">
          <section>
            <h4 className="text-lg text-gray-900 dark:text-white font-bold mb-2 flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors">
              <h5 className="text-indigo-600 dark:text-indigo-400 font-bold mb-2 text-sm">Level 1: 间隔隐藏</h5>
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                保留约50%的词汇。像脚手架一样，利用上下文线索帮助你建立初步的文本脉络。适合刚开始记忆时建立信心。
              </p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors">
              <h5 className="text-indigo-600 dark:text-indigo-400 font-bold mb-2 text-sm">Level 2: 句末隐藏</h5>
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                仅保留每句话的开头。迫使你根据句首提示，预测并还原完整的句子结构。强化对句子逻辑的掌握。
              </p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors">
              <h5 className="text-indigo-600 dark:text-indigo-400 font-bold mb-2 text-sm">Level 3: 仅留段首</h5>
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section>
            <h4 className="text-lg text-gray-900 dark:text-white font-bold mb-2 flex items-center gap-2">
              <span className="text-pink-600 dark:text-pink-500">#</span> 使用建议
            </h4>
            <ul className="list-disc list-inside text-sm space-y-2 text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-900/30 p-4 rounded-lg">
